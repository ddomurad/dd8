...
func TestThatCanBuildBinaryCode(t *testing.T) {
	...
	t.Run("definde_bytes", func(t *testing.T) {
		...
		assertAssembler(t, `.dw 0x0d, 0x0a, 0x0f, "abc"`, []byte{0x00, 0x0d, 0x00, 0x0a, 0x00, 0x0f, 0x00, 'a', 0x00, 'b', 0x00, 'c'})
		assertAssembler(t, `.dw 0xf90d, 0x10a, 0xf`, []byte{0xf9, 0x0d, 0x01, 0x0a, 0x00, 0x0f})
	})
}
