...
VL_INLINE_OPT void Vsprite_test___024root___ico_sequent__TOP__0(Vsprite_test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsprite_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsprite_test___024root___ico_sequent__TOP__0\n"); );
    // Body
...
void Vsprite_test___024root___eval_ico(Vsprite_test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsprite_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsprite_test___024root___eval_ico\n"); );
    // Body
    if (vlSelf->__VicoTriggered.at(0U)) {
        Vsprite_test___024root___ico_sequent__TOP__0(vlSelf);
    }
}

void Vsprite_test___024root___eval_act(Vsprite_test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsprite_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsprite_test___024root___eval_act\n"); );
}

VL_INLINE_OPT void Vsprite_test___024root___nba_sequent__TOP__0(Vsprite_test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsprite_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsprite_test___024root___nba_sequent__TOP__0\n"); );
    // Body
...
VL_INLINE_OPT void Vsprite_test___024root___nba_sequent__TOP__1(Vsprite_test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsprite_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsprite_test___024root___nba_sequent__TOP__1\n"); );
    // Body
    if ((1U == (IData)(vlSelf->dma__DOT___state))) {
        if ((7U < (IData)(vlSelf->dma__DOT___y_diff))) {
    ...
    } else if (((IData)(vlSelf->dma__DOT___last_rst) 
                != (1U & (IData)(vlSelf->line_n)))) {
...
VL_INLINE_OPT void Vsprite_test___024root___nba_comb__TOP__0(Vsprite_test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsprite_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsprite_test___024root___nba_comb__TOP__0\n"); );
    // Body
    vlSelf->r_addr = ((0x200U & ((IData)(vlSelf->line_n) 
                                 << 8U)) | (0x1ffU 
                                            & ((vlSelf->dma__DOT___spr_reg 
...
void Vsprite_test___024root___eval_nba(Vsprite_test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsprite_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsprite_test___024root___eval_nba\n"); );
    // Body
    if (vlSelf->__VnbaTriggered.at(0U)) {
        Vsprite_test___024root___nba_sequent__TOP__0(vlSelf);
    }
    if (vlSelf->__VnbaTriggered.at(1U)) {
        Vsprite_test___024root___nba_sequent__TOP__1(vlSelf);
    }
    if ((vlSelf->__VnbaTriggered.at(0U) | vlSelf->__VnbaTriggered.at(1U))) {
        Vsprite_test___024root___nba_comb__TOP__0(vlSelf);
    }
}
...
void Vsprite_test___024root___eval(Vsprite_test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsprite_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsprite_test___024root___eval\n"); );
    // Init
    ...
    while (__VicoContinue) {
        __VicoContinue = 0U;
        Vsprite_test___024root___eval_triggers__ico(vlSelf);
...
#endif
                VL_FATAL_MT("sprite_test.v", 1, "", "Input combinational region did not converge.");
            }
            vlSelf->__VicoIterCount = ((IData)(1U) 
                                       + vlSelf->__VicoIterCount);
            Vsprite_test___024root___eval_ico(vlSelf);
        }
    }
    __VnbaIterCount = 0U;
    __VnbaContinue = 1U;
    while (__VnbaContinue) {
        ...
        while (vlSelf->__VactContinue) {
            ...
            Vsprite_test___024root___eval_triggers__act(vlSelf);
...
#endif
                    VL_FATAL_MT("sprite_test.v", 1, "", "Active region did not converge.");
                }
                vlSelf->__VactIterCount = ((IData)(1U) 
                                           + vlSelf->__VactIterCount);
                __VpreTriggered.andNot(vlSelf->__VactTriggered, vlSelf->__VnbaTriggered);
                vlSelf->__VnbaTriggered.set(vlSelf->__VactTriggered);
                Vsprite_test___024root___eval_act(vlSelf);
            }
        }
...
#ifdef VL_DEBUG
                Vsprite_test___024root___dump_triggers__nba(vlSelf);
#endif
                VL_FATAL_MT("sprite_test.v", 1, "", "NBA region did not converge.");
            }
            __VnbaIterCount = ((IData)(1U) + __VnbaIterCount);
            Vsprite_test___024root___eval_nba(vlSelf);
        }
    }
}
...
void Vsprite_test___024root___eval_debug_assertions(Vsprite_test___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsprite_test__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsprite_test___024root___eval_debug_assertions\n"); );
    // Body
